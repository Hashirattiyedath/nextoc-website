...
<body>
 ...
 <div class="preloader__new">
	<div class="preloader__img">
	  <img src="./assets/images/logo.png" class="eyez" alt="">
	</div>
</div>
...
<!--=====================================================
					HEADER-SECTION
======================================================-->    
<section class="header_section" id="header" style="background: linear-gradient(to bottom, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 100%);">
    <div class="container">
        <div class="header_wrapper">
            <div class="join_us" data-toggle="modal" data-target="#myModal">
                <h3><a href="#">JOIN US</a> <i class="fa fa-user-circle" aria-hidden="true"></i>
     </h3>
            </div>
            <div class="logo_img">
...
<div class="home_banner_section">
    <!-- Swiper -->
    <div class="swiper-container home_banner_slider">
        <div class="swiper-wrapper">
        <!-- <div class="swiper-slide">
            <div class="slider_area">
                <img loading="lazy" src="assets/images/home_banner/3.jpg" class="img-fluid banner_img" alt="">
            </div>
            <div class="slider-content slider-logo">
                <img loading="lazy" src="./assets/images/logo.png" class="img-fluid" alt="">
            </div>
        </div> -->
        <div class="swiper-slide">
            <div class="slider_area">
                <img loading="lazy" src="assets/images/home_banner/4.jpg" class="img-fluid banner_img" alt="">
            </div>
            <div class="slider-content">
                <h1>SAVE <span>WEALTH</span></h1>
                <p>The very first step to building wealth and spend less than you male </p>
            </div>
        </div>
        <div class="swiper-slide">
            <div class="slider_area">
            ...
            <div class="slider-content">
                <h1>INVEST <span>WEALTH</span></h1>
                <p>an investment in knowledge pays the best interest</p>
            </div>
        </div>
        <div class="swiper-slide">
         <div class="slider_area">
             <img loading="lazy" src="assets/images/home_banner/2.jpg" class="img-fluid banner_img" alt="">
         </div>
         <div class="slider-content">
             <h1>BUILD <span>WEALTH</span></h1>
             <p>A wealth mindset is a set of beliefs, habits, and behaviors that separates the wealthy from the rest.</p>
         </div>
     </div>
        </div>
    </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">our mission is to be better platform for traders by providing them services which are economically and financially beneficial to them and create Awareness regarding the safe trading and investment</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Nextoc here promises the traders well designed, informative lessons and dedicated support that meet their trading goals</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">To grow along with our clients by trading in major stocks and make Nextoc the finest area for traders .Our aim is to build real partnership with a limited number of clients by providing consistent and top quality services</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-6">
                  <div class="service_box">
                       ...
                       <g>
                        ...
                        <div class="detail">
                           <h5>Crypto suggestion</h5>
                           <p>A mutual fund is simply a financial intermediary that allows a group of investors to pool their money together with a predetermined investment objective.</p>
                           <div class="mt-auto link-1">Explore</div>
                        </div>
                     </div>
               </div>
...
<!--=====================================================
					OUR SERVICES
======================================================--> 
<section class="content services-content-block">
  <div class="container">
        ...
        <div class="wpb_column vc_column_container vc_col-sm-12">
           <div class="vc_column-inner">
              <div class="wpb_wrapper">
                 ...
                 <div class="vc_row wpb_row vc_inner vc_row-fluid d-md-flex d-block">
                    <div class="wpb_column vc_column_container vc_col-sm-4 course_box">
                       <div class="vc_column-inner">
                          <div class="wpb_wrapper">
                             <div class="content-box wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                                ...
                                <div class="right">
                                   ...
                                   <p>For Equity Traders<br></p>
                                   <ul class="course_ul">
                                      <li>Basic session</li>
                                      <li>Intraday session</li>
                                      <li>Core Strategy Course</li>
                                      <li>Midterms and long term investment</li>
                                   </ul>
                                </div>
                                <!-- end right -->
                             </div>
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-4">
                       <div class="vc_column-inner">
                          <div class="wpb_wrapper">
                             <div class="content-box wow fadeIn" data-wow-delay="0.05s" style="visibility: visible; animation-delay: 0.05s; animation-name: fadeIn;">
                                <div class="left">
                                ...
                                <div class="right">
                                   ...
                                   <p>For all segment Like Equity , F&amp;O , Commodities</p>
                                   <ul class="course_ul">
                                      <li>Individual Assisatance</li>
                                      <li>Trade in MCX</li>
                                      <li>Trade in Forex</li>
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-4">
                       <div class="vc_column-inner">
                          <div class="wpb_wrapper">
                             <div class="content-box wow fadeIn" data-wow-delay="0.10s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                <div class="left">
                                   <small>03</small><span></span>
                                </div>
                                <div class="right">
                                   <h4>Premium Plus Memebership</h4>
                                   <p>Recommended For Segment Options &amp; Futures !<br>
                                   </p>
                                   <ul class="course_ul">
                                      <li>Basics Stock Market</li>
                                      <li>Basics of Index</li>
                                      <li>Basics of Options</li>
                                      <li>Basics Of Options Chain</li>
                                      <li>Details Of Options</li>
                                   </ul>
                                </div>
                             </div>
                          </div>
...
<section class="content process">
  <div class="container">
     <div class="vc_row wpb_row vc_row-fluid">
        <div class="wpb_column vc_column_container vc_col-sm-12">
           <div class="vc_column-inner">
              <div class="wpb_wrapper m-auto">
                 <div class="brabus-intro-wrapper" wow="" fadein"="">
                    <h6>This is how we do!</h6>
                    <h2 data-text="HOW ?">The Process</h2>
                 </div>
                 <div class="vc_row wpb_row vc_inner vc_row-fluid process_method">
                    <div class="wpb_column vc_column_container vc_col-sm-3 process_wrapper">
                       <div class="vc_column-inner">
                          <div class="wpb_wrapper">
                             <div class="process-item wow fadeIn" data-wow-delay="0s" style="visibility: visible; animation-delay: 0s; animation-name: fadeIn;">
                                <span>01</span>
                                <figure>
                                   <img loading="lazy" src="./assets/images/process/icon01.jpg" alt="PREPARETION">
                                   <figcaption>
                                      <h5>WE PREPARE YOU</h5>
                                   </figcaption>
                                </figure>
                             </div>
                          </div>
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-3">
                       <div class="vc_column-inner">
                          <div class="wpb_wrapper">
                             <div class="process-item wow fadeIn" data-wow-delay="0.05s" style="visibility: visible; animation-delay: 0.05s; animation-name: fadeIn;">
                                <span>02</span>
                                <figure>
                                   <img loading="lazy" src="./assets/images/process/icon02.jpg" alt="PROTOTYPE">
                                   <figcaption>
                                      <h5>WE TEACH YOU</h5>
                                   </figcaption>
                                </figure>
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-3">
                       <div class="vc_column-inner">
                          <div class="wpb_wrapper">
                             <div class="process-item wow fadeIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                <span>03</span>
                                <figure>
                                   <img loading="lazy" src="./assets/images/process/icon03.jpg" alt="EXECUTION">
                                   <figcaption>
                                      <h5>WE EXECUTE LIVE TRADE</h5>
                                   </figcaption>
                                </figure>
                             </div>
                          </div>
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-3">
                       <div class="vc_column-inner">
                          <div class="wpb_wrapper">
                             <div class="process-item wow fadeIn" data-wow-delay="0.15s" style="visibility: visible; animation-delay: 0.15s; animation-name: fadeIn;">
                                <span>04</span>
                                <figure>
                                   <img loading="lazy" src="./assets/images/process/icon04.jpg" alt="LUNCHED">
                                   <figcaption>
                                      <h5>WE MAKE YOU INDEPENDENT </h5>
                                   </figcaption>
                                </figure>
                             </div>
                          </div>
